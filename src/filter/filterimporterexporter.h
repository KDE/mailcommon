...
public:
     ...
     * If @p interactive is true, a dialog will offer to select a different account if the filter refers to one that doesn't exist.
     * @p interactive = true makes the most sense for actual import use cases, probably? less for loading filters at startup.
     */
